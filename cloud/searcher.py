...
MAX_WORKERS = mp.cpu_count()-1		# max amount of concurrent workers
MAX_PROCS = 2*MAX_WORKERS			# max amount of prepared processes in pool (a amount too high will waste RAM)
